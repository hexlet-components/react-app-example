...
Минимальная связка «React-приложение плюс сервер, который его отдаёт». Нужна
там, где надо показать сборку и раздачу фронтенда, не отвлекаясь на саму
логику приложения.

Фронтенд лежит в `frontend/` отдельным пакетом workspace, корень отвечает
только за раздачу собранного.
